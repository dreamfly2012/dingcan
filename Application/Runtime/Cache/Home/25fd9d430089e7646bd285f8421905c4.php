	...
	<div class="content-right">
        <div class="page-header">
    	   ...
    	   <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
            <?php if(is_array($collections)): foreach($collections as $key=>$collection): ?><tr>
                <td><a href="<?php echo U('Goods/goodsDetail',array('goods_id'=>$collection['goods_id']));?>"><?php echo ($collection["goods_name"]); ?></a></td> 
                <td><?php echo ($collection["shop_price"]); ?></td> 
                <td><a href="javascript:;" class="del_collcet" data-goods-id="<?php echo ($collection['goods_id']); ?>">删除</a></td> 
