...
<div class="listbox">
    <div class="pro-list">
        <div class="pro-title">
            <p class="order">排序：</p>
            <?php if(I('request.order')==null && I('request.direction')==null): ?>
                    <a class="active" href="<?php echo U('Goods/exchangeGoods',array('order'=>'goods_name','direction'=>'asc'));?>">按商品名称排序</a>
            <?php elseif(I('request.order')=='add_time' && I('request.direction')=='asc'): ?>        
                    <a class="" href="<?php echo U('Goods/exchangeGoods',array('order'=>'goods_name','direction'=>'desc'));?>">按商品名称排序</a>
            <?php else: ?>        
                    <a class="" href="<?php echo U('Goods/exchangeGoods',array('order'=>'goods_name','direction'=>'asc'));?>">按商品名称排序</a>
            <?php endif; ?>

            <?php if(I('request.order')=='add_time' && I('request.direction')=='asc'): ?>
                    <a class="fl active" href="<?php echo U('Goods/exchangeGoods',array('order'=>'add_time','direction'=>'asc'));?>">按上架时间排序</a>
            <?php elseif(I('request.order')=='add_time' && I('request.order')=='asc')): ?>        
                    <a class="fl" href="<?php echo U('Goods/exchangeGoods',array('order'=>'add_time','direction'=>'desc'));?>">按上架时间排序</a>
            <?php else: ?>        
                    <a class="" href="<?php echo U('Goods/exchangeGoods',array('order'=>'add_time','direction'=>'asc'));?>">按上架时间排序</a>
            <?php endif; ?>

            <?php if(I('request.order')=='integral' && I('request.direction')=='asc'): ?>
                    <a class="active" href="<?php echo U('Goods/exchangeGoods',array('order'=>'integral','direction'=>'asc'));?>">按积分排序</a>
            <?php elseif(isset(I('request.order') && I('request.order')=='asc')): ?>        
                    <a class="" href="<?php echo U('Goods/exchangeGoods',array('order'=>'integral','direction'=>'desc'));?>">按积分排序</a>
            <?php else: ?>        
                    <a class="" href="<?php echo U('Goods/exchangeGoods',array('order'=>'integral','direction'=>'asc'));?>">按积分排序</a>
            <?php endif; ?>

        </div>
        <div class="pro-body">
            <ul>
                <?php if(is_array($exchange_goods_list)): foreach($exchange_goods_list as $key=>$exchange_goods): ?><li>
                    <div class="pro-img">
                        <a href="<?php echo U('Goods/goodsDetail',array('goods_id'=>$exchange_goods['goods_id']));?>"><img src="/Public/Home/images/grey.gif" data-original="/Uploads/<?php echo ($exchange_goods["goods_img"]); ?>"  class="lazy" style="height:180px;width:180px"></a>
                    </div>
                    <a href="<?php echo U('Goods/goodsDetail',array('goods_id'=>$exchange_goods['goods_id']));?>" class="font20">
                    <span class="exchange">消耗积分：:<?php echo ($exchange_goods["integral"]); ?></span>
                    </a>
                    <p class="blacktext">
                    <a href="<?php echo U('Goods/goodsDetail',array('goods_id'=>$exchange_goods['goods_id']));?>" class="font20"></a>
                    <a href="<?php echo U('Goods/goodsDetail',array('goods_id'=>$exchange_goods['goods_id']));?>"><?php echo ($exchange_goods["goods_name"]); ?></a>
                    </p>
