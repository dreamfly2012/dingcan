...
.content-right .login-info ul{width:870px; margin:0 auto;}
    ...
    <div class="content-right">
        ...
        <form action="<?php echo U('User/couponExchange');?>" method="post" class="form-horizontal">
            <div class="control-group">
                <label class="control-label" for="coupon_code">兑换券</label>

                <div class="controls">
                    <input type="text" name="coupon_code" id="coupon_code" placeholder="兑换券" value="">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="coupon_pwd">密码</label>

                <div class="controls">
                    <input type="text" name="coupon_code" id="coupon_pwd" placeholder="兑换券密码" value="">
                </div>
            </div>
