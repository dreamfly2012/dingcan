        ...
        <div class="modal-body">
            ...
            <div class="control-group">
                <div class="controls">
                    ...
                    <button type="submit" class="login btn btn-primary">登陆</button>
                </div>
            </div>
        </div>
    </form>
