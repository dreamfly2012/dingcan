    ...
    <div class="container">
        ...
        <form role="form" class="form" method="post" action="<?php echo U('Auth/authAddGroupHandle');?>">
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-control" id="title" placeholder="权限组名称">
            </div>
            <div class="form-group">
                <?php if(is_array($auth_rule)): foreach($auth_rule as $key=>$auth_rule): ?><input type="checkbox" name="auth_rule_id[]" value="<?php echo ($auth_rule["id"]); ?>"> <?php echo ($auth_rule["title"]); endforeach; endif; ?>
            </div>
            <div class="form-group">
