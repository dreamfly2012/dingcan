...
<div class="left">
    <ul class="list-group black">
        <li class="list-group-item"><a href="<?php echo U('Store/basicSetting');?>">基本信息</a></li>
        <li class="list-group-item"><a href="<?php echo U('Store/displaySetting');?>">显示设置</a></li>
    </ul>
</div>
...
<div class="right">
    <div class="container">
    <h2>商店基本信息</h2>
    <form action="<?php echo U('Store/storeBasicSettingHandle');?>" method="post" class="form" role="form">
