...
<div class="right">
    <div class="container">
        <h2>等级编辑</h2>
        <form name="form" id="form" action="<?php echo U('Member/updateRank');?>" method="post" class="form" role="form">
            <div class="container">
    ...
    <div class="form-group">
        <label for="min_points">积分下线</label>
        <input type="text" name="min_points" id="min_points" value="<?php echo ($rank["min_points"]); ?>" class="form-control" />
    </div>

    <div class="form-group">
        <label for="max_points">积分上线</label>
        <input type="text" name="max_points" id="max_points" value="<?php echo ($rank["max_points"]); ?>" class="form-control" />
    </div>
